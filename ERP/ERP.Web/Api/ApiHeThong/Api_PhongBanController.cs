...
namespace ERP.Web.Api.ApiHeThong
{
    public class Api_PhongBanController : ApiController
    {
        ...
        // PUT: api/Api_DanhSachPhongBan/5
        ...
        // DELETE: api/Api_DanhSachPhongBan/5
        [ResponseType(typeof(CCTC_PHONG_BAN))]
