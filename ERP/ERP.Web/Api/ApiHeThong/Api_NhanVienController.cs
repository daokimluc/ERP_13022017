...
namespace ERP.Web.Api.ApiHeThong
{
    public class Api_NhanVienController : ApiController
    {
        ...
        // PUT: api/Api_DanhSachNhanVien/5
        ...
        // DELETE: api/Api_DanhSachNhanVien/5
        [ResponseType(typeof(CCTC_NHAN_VIEN))]
